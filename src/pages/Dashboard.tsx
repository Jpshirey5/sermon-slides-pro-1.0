...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <AlertDialog open={welcomeModalOpen}>
        <AlertDialogContent onEscapeKeyDown={(event) => event.preventDefault()}>
          <AlertDialogHeader>
            <AlertDialogTitle>Welcome to Sermon Slide Pro</AlertDialogTitle>
            <AlertDialogDescription>
              Your subscription is active. You are all set to start creating presentations.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogAction onClick={() => setWelcomeModalOpen(false)}>Continue</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
    </>
